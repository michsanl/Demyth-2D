...
/// </summary>
[Serializable]
public class SceneReferenceGlobal : ISerializationCallbackReceiver
{
#if UNITY_EDITOR
    ...
    public static implicit operator string(SceneReferenceGlobal sceneReference)
    {
...
/// </summary>
[CustomPropertyDrawer(typeof(SceneReferenceGlobal))]
